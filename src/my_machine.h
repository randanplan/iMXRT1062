...
#define INVERT_CONTROL_PIN_MASK 73 //79
#define INVERT_LIMIT_PIN_MASK 7
#define DEFAULT_SPINDLE_AT_SPEED_TOLERANCE 0.1f
#define DEFAULT_SPINDLE_PPR 2000
#define SPINDLE_SYNC_ENABLE
#define REPORT_WCO_REFRESH_BUSY_COUNT 20
#define REPORT_WCO_REFRESH_IDLE_COUNT 10
#define DWELL_TIME_STEP 10 // Integer (1-255) (milliseconds)
// #define DEFAULT_REPORT_MACHINE_POSITION
...
// #define SPINDLE_JMC          0 // JMC modbus Spindle plugin 
#define SPINDLE_ODRIVE       1 // ODrive CAN Spindle plugin 
...
#define EEPROM_ENABLE      3 // I2C EEPROM support. Set to 1 for 24LC16(2K), 2 for larger sizes. Requires eeprom plugin.
...
#undef SPINDLEPWMPIN
#endif
#if SPINDLE_HUANYANG || SPINDLE_ODRIVE
